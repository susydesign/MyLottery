                          ...
                          <div class="col-md-9 register-right">
                              ...
                              <div class="tab-content" id="myTabContent">
                                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                      ...
                                      <form target="print_popup" action="./php/jatek.php" method="POST">
                                      <div class="row register-form" style="padding-bottom: 0px;">
                                          <div class="col-md-2"></div>
                                          <div class="col-md-8">
  
                                            <div class="form-group">
                                                <input type="TEXT" class="form-control" placeholder="Player" value="<?php $_SESSION['username'] ?>" name="fuser"/>
                                            </div>

                                            <div class="form-group">
                                                <input type="time" step="2" class="inp_fogad1 form-control" placeholder="Óra" value="Óra-perc-mp" name="fogad1"/>
                                            </div>
                                          </div>
                                          <div class="col-md-2"></div>
                                      </div>
                                      <div class="row register-form" style="margin-top:10px">
                                          <div class="col-lg-4">
                                              <div class="form-group">
                                                  <input type="month" class="form-control" placeholder="Hónap" value="Hónap" 
                                                  name="fogad4"/>
                                              </div>
                                          </div>
                                          <div class="col-lg-4">
                                              <div class="form-group">
                                                  <input type="week" class="form-control" placeholder="Hét" value="" name="fogad3"/>
                                              </div>
                                          </div>
                                          <div class="col-lg-4">
                                              <div class="form-group">
                                              <input type="date" class="form-control" name="fogad2" placeholder="nap" value="nap" />
                                              </div>
                                          </div>
                                  ...
                                  <div class="tab-pane fade show" id="demo" role="tabpanel" aria-labelledby="demo-tab">
                                      ...
                                      <div class="row register-form" style="padding-bottom: 0px;">
                                          ...
                                          <div class="col-md-8">
                                              <div class="form-group">
                                                  <input type="time" step="2" class="inp_fogad1 form-control" placeholder="Óra *" value="" />
                                              </div>
                                          </div>
                                          <div class="col-md-2"></div>
                                      </div>
                                      <div class="row register-form" style="margin-top:10px">
                                          <div class="col-lg-4">
                                              <div class="form-group">
                                                  <input type="month" class="form-control" placeholder="Hónap" value="" 
                                                  name="fogad4"/>
                                              </div>
                                          </div>
                                          <div class="col-lg-4">
                                              <div class="form-group">
                                                  <input type="week" class="form-control" name="fogad3" placeholder="Hét" value="" />
                                              </div>
                                          </div>
                                          <div class="col-lg-4">
                                              <div class="form-group">
                                              <input type="date" class="form-control" name="fadad2" placeholder="nap" value="" />
                                              </div>
                                          </div>
