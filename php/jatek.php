...
//    $fogad1 = "'".$_POST['fogad1']."'";
    ...
    $sql_wall = "UPDATE `wallet` SET `amunt`= amunt-$jatek_price,`bonus1`= bonus1+1 WHERE user_id=$fuserId";
    ...
    if ($fogad4 != "") {
        ...
        //Csökkentjük a pénztárcát.
        $sql_wall = "UPDATE `wallet` SET `amunt`= amunt-$jatek_price,`bonus4`= bonus4+1 WHERE user_id=$fuserId";
        ...
        //Csökkentjük a pénztárcát.
        $sql_wall = "UPDATE `wallet` SET `amunt`= amunt-$jatek_price,`bonus3`= bonus3+1 WHERE user_id=$fuserId";
        ...
        //Csökkentjük a pénztárcát.
        $sql_wall = "UPDATE `wallet` SET `amunt`= amunt-$jatek_price,`bonus2`= bonus2+1 WHERE user_id=$fuserId";
